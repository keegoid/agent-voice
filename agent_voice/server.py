...
TTS_RETRY_TEMPERATURE = float(os.getenv("AGENT_VOICE_TTS_RETRY_TEMPERATURE") or "0.6")
...
def _notify_default_voice() -> str:
    configured = os.getenv("AGENT_VOICE_NOTIFY_DEFAULT_VOICE") or "chesapeake_balanced"
    return configured if configured in VOICE_DESIGNS else "chesapeake_balanced"

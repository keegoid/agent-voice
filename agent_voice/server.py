...
def _notify_default_voice() -> str:
    configured = os.getenv("AGENT_VOICE_NOTIFY_DEFAULT_VOICE") or "cool_street_deadpan"
    return configured if configured in VOICE_DESIGNS else "cool_street_deadpan"
